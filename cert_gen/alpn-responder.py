...
ALPNDIR=os.path.join(os.path.dirname(os.path.abspath(__file__)),"alpn-certs")
PROXY_PROTOCOL=False

FALLBACK_CERTIFICATE="/etc/ssl/certs/ssl-cert-snakeoil.pem"
# FALLBACK_CERTIFICATE=os.path.join(os.path.dirname(os.path.abspath(__file__)), "snakeoil", "ssl-cert-snakeoil.pem")
FALLBACK_KEY="/etc/ssl/private/ssl-cert-snakeoil.key"
# FALLBACK_KEY=os.path.join(os.path.dirname(os.path.abspath(__file__)), "snakeoil", "ssl-cert-snakeoil.key")
